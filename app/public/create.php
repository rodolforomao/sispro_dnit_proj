...
// Variáveis: $equipes, $responsaveis, $tipos, $statuses, $uf_lista
?>
<!DOCTYPE html>
<html lang="pt">
<head>
...
<div class="container mt-4">
    <div class="card">
        ...
        <div class="checkbox-top mb-4 p-3 bg-light rounded-3">
            ...
            <div class="form-check form-check-inline" id="div_cadastrado_sima" style="display:none;">
                <input type="checkbox" name="cadastrado_sima" class="form-check-input" id="cadastrado_sima">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="assunto" class="form-control" rows="2" maxlength="100"></textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label required"><i class="bi bi-lightbulb"></i> Providência (máx. 100)</label>
                        <textarea name="providencia" class="form-control" rows="2" maxlength="100"></textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="bi bi-sticky"></i> Observações (máx. 100)</label>
                        <textarea name="observacoes" class="form-control" rows="2" maxlength="100"></textarea>
                    </div>
                </div>
            </div>
